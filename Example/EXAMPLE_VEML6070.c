...
---------------------------------------------------------------------- */
#ifndef __VEML6070_EXAMPLE__
#define __VEML6070_EXAMPLE__
...
void  EXAMPLE_VEML6070(void)
{
		...
		if(run==1)
			...
			if(status!=1) printf("VEML6070 set mode fail !\r\n");
			else  printf("VEML6070 set mode success !\r\n");
			run=0;	
...
{			//if change any parameter -> define  VEML6070_COMMAND
			...
			if(status!=0) printf("VEML6070 set mode fail !\r\n");
			else printf("VEML6070 UV data = %d\r\n", uv_data);
			...
			//see VEML6070 application note & Rset & refresh time!
		      if(uv_data<=560)printf("LOW\r\n");
	            else if(uv_data>560 && uv_data<=1120)printf("MID\r\n"); 
	            else if(uv_data>1121 && uv_data<=1494)printf("HIGH\r\n"); 
	            else if(uv_data>1495 && uv_data<=2054)printf("VHIGH\r\n");    
	            else if(uv_data>2055)printf("EXT!!\r\n"); 	
...
#endif		//#ifndef __VEML6070_EXAMPLE__
